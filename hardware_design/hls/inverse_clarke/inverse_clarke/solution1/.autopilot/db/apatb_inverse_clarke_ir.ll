; ModuleID = 'C:/git/bldc-driver-fpga/hardware_design/hls/inverse_clarke/inverse_clarke/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_inverse_clarke_ir(%"class.hls::stream<unsigned long long, 0>"* %idq, %"class.hls::stream<unsigned short, 0>"* %theta, %"class.hls::stream<unsigned long long, 0>"* %vectors) local_unnamed_addr #1 {
entry:
  ...
  call void @apatb_inverse_clarke_hw(%"class.hls::stream<unsigned long long, 0>"* %idq_copy, %"class.hls::stream<unsigned short, 0>"* %theta_copy, %"class.hls::stream<unsigned long long, 0>"* %vectors_copy)
...
declare void @apatb_inverse_clarke_hw(%"class.hls::stream<unsigned long long, 0>"*, %"class.hls::stream<unsigned short, 0>"*, %"class.hls::stream<unsigned long long, 0>"*)

define void @inverse_clarke_hw_stub_wrapper(%"class.hls::stream<unsigned long long, 0>"*, %"class.hls::stream<unsigned short, 0>"*, %"class.hls::stream<unsigned long long, 0>"*) #6 {
entry:
  ...
  call void @inverse_clarke_hw_stub(%"class.hls::stream<unsigned long long, 0>"* %0, %"class.hls::stream<unsigned short, 0>"* %1, %"class.hls::stream<unsigned long long, 0>"* %2)
...
declare void @inverse_clarke_hw_stub(%"class.hls::stream<unsigned long long, 0>"*, %"class.hls::stream<unsigned short, 0>"*, %"class.hls::stream<unsigned long long, 0>"*)

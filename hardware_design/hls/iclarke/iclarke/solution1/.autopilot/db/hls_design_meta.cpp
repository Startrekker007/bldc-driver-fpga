...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("axis_debug_TDATA", 32, hls_out, 2, "axis", "out_data", 1),
	Port_Property("axis_debug_TVALID", 1, hls_out, 2, "axis", "out_vld", 1),
	Port_Property("axis_debug_TREADY", 1, hls_in, 2, "axis", "out_acc", 1),
};
const char* HLS_Design_Meta::dut_name = "iclarke";

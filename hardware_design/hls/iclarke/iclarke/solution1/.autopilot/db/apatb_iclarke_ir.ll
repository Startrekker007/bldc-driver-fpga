; ModuleID = 'C:/git/bldc-driver-fpga/hardware_design/hls/iclarke/iclarke/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_iclarke_ir(%"class.hls::stream<unsigned long long, 0>"* %data_in, %"class.hls::stream<unsigned long long, 0>"* %current_out, %"class.hls::stream<int, 0>"* %axis_debug) local_unnamed_addr #1 {
entry:
  ...
  %axis_debug_copy = alloca %"class.hls::stream<int, 0>", align 512
  call void @llvm.sideeffect() #0 [ "stream_interface"(%"class.hls::stream<int, 0>"* %axis_debug_copy) ]
  call fastcc void @copy_in(%"class.hls::stream<unsigned long long, 0>"* %data_in, %"class.hls::stream<unsigned long long, 0>"* nonnull align 512 %data_in_copy, %"class.hls::stream<unsigned long long, 0>"* %current_out, %"class.hls::stream<unsigned long long, 0>"* nonnull align 512 %current_out_copy, %"class.hls::stream<int, 0>"* %axis_debug, %"class.hls::stream<int, 0>"* nonnull align 512 %axis_debug_copy)
  call void @apatb_iclarke_hw(%"class.hls::stream<unsigned long long, 0>"* %data_in_copy, %"class.hls::stream<unsigned long long, 0>"* %current_out_copy, %"class.hls::stream<int, 0>"* %axis_debug_copy)
  call fastcc void @copy_out(%"class.hls::stream<unsigned long long, 0>"* %data_in, %"class.hls::stream<unsigned long long, 0>"* nonnull align 512 %data_in_copy, %"class.hls::stream<unsigned long long, 0>"* %current_out, %"class.hls::stream<unsigned long long, 0>"* nonnull align 512 %current_out_copy, %"class.hls::stream<int, 0>"* %axis_debug, %"class.hls::stream<int, 0>"* nonnull align 512 %axis_debug_copy)
  ret void
}

; Function Attrs: argmemonly noinline
define internal fastcc void @copy_in(%"class.hls::stream<unsigned long long, 0>"*, %"class.hls::stream<unsigned long long, 0>"* noalias align 512 "fpga.caller.interfaces"="layout_transformed", %"class.hls::stream<unsigned long long, 0>"*, %"class.hls::stream<unsigned long long, 0>"* noalias align 512 "fpga.caller.interfaces"="layout_transformed", %"class.hls::stream<int, 0>"*, %"class.hls::stream<int, 0>"* noalias align 512 "fpga.caller.interfaces"="layout_transformed") unnamed_addr #2 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @copy_out(%"class.hls::stream<unsigned long long, 0>"*, %"class.hls::stream<unsigned long long, 0>"* noalias align 512 "fpga.caller.interfaces"="layout_transformed", %"class.hls::stream<unsigned long long, 0>"*, %"class.hls::stream<unsigned long long, 0>"* noalias align 512 "fpga.caller.interfaces"="layout_transformed", %"class.hls::stream<int, 0>"*, %"class.hls::stream<int, 0>"* noalias align 512 "fpga.caller.interfaces"="layout_transformed") unnamed_addr #5 {
entry:
...
declare void @apatb_iclarke_hw(%"class.hls::stream<unsigned long long, 0>"*, %"class.hls::stream<unsigned long long, 0>"*, %"class.hls::stream<int, 0>"*)

define void @iclarke_hw_stub_wrapper(%"class.hls::stream<unsigned long long, 0>"*, %"class.hls::stream<unsigned long long, 0>"*, %"class.hls::stream<int, 0>"*) #6 {
entry:
  call void @copy_out(%"class.hls::stream<unsigned long long, 0>"* null, %"class.hls::stream<unsigned long long, 0>"* %0, %"class.hls::stream<unsigned long long, 0>"* null, %"class.hls::stream<unsigned long long, 0>"* %1, %"class.hls::stream<int, 0>"* null, %"class.hls::stream<int, 0>"* %2)
  call void @iclarke_hw_stub(%"class.hls::stream<unsigned long long, 0>"* %0, %"class.hls::stream<unsigned long long, 0>"* %1, %"class.hls::stream<int, 0>"* %2)
  call void @copy_in(%"class.hls::stream<unsigned long long, 0>"* null, %"class.hls::stream<unsigned long long, 0>"* %0, %"class.hls::stream<unsigned long long, 0>"* null, %"class.hls::stream<unsigned long long, 0>"* %1, %"class.hls::stream<int, 0>"* null, %"class.hls::stream<int, 0>"* %2)
  ret void
}

declare void @iclarke_hw_stub(%"class.hls::stream<unsigned long long, 0>"*, %"class.hls::stream<unsigned long long, 0>"*, %"class.hls::stream<int, 0>"*)

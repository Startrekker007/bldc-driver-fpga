...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_data_in_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_current_out_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	inverse_park {
		data_in {Type I LastRead 0 FirstWrite -1}
		current_out {Type O LastRead -1 FirstWrite 0}}}

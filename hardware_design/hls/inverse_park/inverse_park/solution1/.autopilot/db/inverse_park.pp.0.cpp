...
const int32_t hardilim = 5000;


__attribute__((sdx_kernel("inverse_park", 0))) void inverse_park(hls::stream<uint64_t> &data_in, hls::stream<uint64_t> &current_out){
#pragma HLSDIRECTIVE TOP name=inverse_park
# 13 "inverse_park.cpp"

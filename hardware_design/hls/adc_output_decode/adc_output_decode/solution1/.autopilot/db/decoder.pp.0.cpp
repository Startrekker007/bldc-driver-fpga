...
__attribute__((sdx_kernel("decoder", 0))) void decoder(hls::stream<adc_packet> &adc_data_axis, hls::stream<uint16_t> &phase_B, hls::stream<uint16_t> &phase_A, hls::stream<uint16_t> &vbus);
# 2 "decoder.cpp" 2
...
__attribute__((sdx_kernel("decoder", 0))) void decoder(hls::stream<adc_packet> &adc_data_axis, hls::stream<uint16_t> &phase_B, hls::stream<uint16_t> &phase_A, hls::stream<uint16_t> &vbus){
#pragma HLSDIRECTIVE TOP name=decoder
# 8 "decoder.cpp"

...
architecture behav of dds_scaler is 
    ...
    signal tmp_user_V_reg_140 : STD_LOGIC_VECTOR (1 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal sdat_fu_124_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal ap_CS_fsm_state4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state4 : signal is "none";
    signal grp_fu_133_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal dds_dat_fu_115_p4 : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal grp_fu_133_p10 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state1)) then
                tmp_user_V_reg_140 <= dds_TUSER_int_regslice;
            end if;
        end if;
    end process;
    ...
    dds_dat_fu_115_p4 <= grp_fu_133_p2(31 downto 16);

    grp_fu_133_ce_assign_proc : process(ap_start, ap_CS_fsm_state1, dds_TVALID_int_regslice)
    begin
    ...
    grp_fu_133_p1 <= grp_fu_133_p10(16 - 1 downto 0);
    grp_fu_133_p10 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(scale),32));
    sdat_fu_124_p2 <= std_logic_vector(unsigned(dds_dat_fu_115_p4) + unsigned(ap_const_lv16_7FFF));
    u <= sdat_fu_124_p2;

    u_ap_vld_assign_proc : process(tmp_user_V_reg_140, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) and (tmp_user_V_reg_140 = ap_const_lv2_0))) then 
    ...
    v_ap_vld_assign_proc : process(tmp_user_V_reg_140, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) and (tmp_user_V_reg_140 = ap_const_lv2_1))) then 
    ...
    w_ap_vld_assign_proc : process(tmp_user_V_reg_140, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) and (tmp_user_V_reg_140 = ap_const_lv2_2))) then 

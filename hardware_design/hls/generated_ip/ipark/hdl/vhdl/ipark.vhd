...
architecture behav of ipark is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "ipark_ipark,hls_ip_2021_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=5.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=3.871000,HLS_SYN_LAT=10,HLS_SYN_TPT=none,HLS_SYN_MEM=4,HLS_SYN_DSP=0,HLS_SYN_FF=669,HLS_SYN_LUT=320,HLS_VERSION=2021_2}";
    ...
    component ipark_mul_32s_32s_63_5_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component ipark_cos_lut_ROM_AUTO_1R IS
    generic (
        DataWidth : INTEGER;
    ...
    component ipark_sin_lut_ROM_AUTO_1R IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
    ...
    component ipark_regslice_both IS
    generic (
        DataWidth : INTEGER );
    port (
        ap_clk : IN STD_LOGIC;
...
begin
    cos_lut_U : component ipark_cos_lut_ROM_AUTO_1R
    generic map (
        DataWidth => 32,
        AddressRange => 1023,
        AddressWidth => 10)
    ...
    sin_lut_U : component ipark_sin_lut_ROM_AUTO_1R
    generic map (
        DataWidth => 32,
        AddressRange => 1023,
        AddressWidth => 10)
    ...
    mul_32s_32s_63_5_1_U1 : component ipark_mul_32s_32s_63_5_1
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    mul_32s_32s_63_5_1_U2 : component ipark_mul_32s_32s_63_5_1
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    mul_32s_32s_63_5_1_U3 : component ipark_mul_32s_32s_63_5_1
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    mul_32s_32s_63_5_1_U4 : component ipark_mul_32s_32s_63_5_1
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    regslice_both_idq_U : component ipark_regslice_both
    generic map (
        DataWidth => 64)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_theta_U : component ipark_regslice_both
    generic map (
        DataWidth => 16)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_vectors_U : component ipark_regslice_both
    generic map (
        DataWidth => 64)
    port map (
        ap_clk => ap_clk,

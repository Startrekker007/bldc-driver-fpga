...
HD_PWD='C:/GIT/bldc-driver-fpga/hardware_design/vivado_project/adc-test/adc-test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log adc_test_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source adc_test_wrapper.tcl -notrace

...
HD_PWD='C:/GIT/bldc-driver-fpga/hardware_design/vivado_project/adc-test/adc-test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adc_test_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adc_test_wrapper.tcl

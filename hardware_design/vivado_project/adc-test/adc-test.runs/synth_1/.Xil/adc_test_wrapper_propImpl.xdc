set_property SRC_FILE_INFO {cfile:c:/GIT/bldc-driver-fpga/hardware_design/vivado_project/adc-test/adc-test.gen/sources_1/bd/adc_test/ip/adc_test_processing_system7_0_0/adc_test_processing_system7_0_0.xdc rfile:../../../adc-test.gen/sources_1/bd/adc_test/ip/adc_test_processing_system7_0_0/adc_test_processing_system7_0_0.xdc id:1 order:EARLY scoped_inst:adc_test_i/processing_system7_0/inst} [current_design]
set_property SRC_FILE_INFO {cfile:c:/GIT/bldc-driver-fpga/hardware_design/vivado_project/adc-test/adc-test.gen/sources_1/bd/adc_test/ip/adc_test_axi_dma_0_0/adc_test_axi_dma_0_0.xdc rfile:../../../adc-test.gen/sources_1/bd/adc_test/ip/adc_test_axi_dma_0_0/adc_test_axi_dma_0_0.xdc id:2 order:EARLY scoped_inst:adc_test_i/axi_dma_0/U0} [current_design]
set_property SRC_FILE_INFO {cfile:X:/Xilinx/Vivado/2020.2/data/ip/xpm/xpm_memory/tcl/xpm_memory_xdc.tcl rfile:X:/Xilinx/Vivado/2020.2/data/ip/xpm/xpm_memory/tcl/xpm_memory_xdc.tcl id:3 order:LATE scoped_inst:{adc_test_i/smartconnect_0/inst/s00_nodes/s00_aw_node/inst/inst_mi_handler/gen_normal_area.inst_fifo_node_payld/gen_xpm_memory_fifo.inst_fifo/gen_mem_rep[0].inst_xpm_memory} unmanaged:yes} [current_design]
set_property SRC_FILE_INFO {cfile:X:/Xilinx/Vivado/2020.2/data/ip/xpm/xpm_memory/tcl/xpm_memory_xdc.tcl rfile:X:/Xilinx/Vivado/2020.2/data/ip/xpm/xpm_memory/tcl/xpm_memory_xdc.tcl id:4 order:LATE scoped_inst:{adc_test_i/smartconnect_0/inst/s00_nodes/s00_b_node/inst/inst_mi_handler/gen_normal_area.inst_fifo_node_payld/gen_xpm_memory_fifo.inst_fifo/gen_mem_rep[0].inst_xpm_memory} unmanaged:yes} [current_design]
set_property SRC_FILE_INFO {cfile:X:/Xilinx/Vivado/2020.2/data/ip/xpm/xpm_memory/tcl/xpm_memory_xdc.tcl rfile:X:/Xilinx/Vivado/2020.2/data/ip/xpm/xpm_memory/tcl/xpm_memory_xdc.tcl id:5 order:LATE scoped_inst:{adc_test_i/smartconnect_0/inst/s00_nodes/s00_w_node/inst/inst_mi_handler/gen_normal_area.inst_fifo_node_payld/gen_xpm_memory_fifo.inst_fifo/gen_mem_rep[0].inst_xpm_memory} unmanaged:yes} [current_design]
current_instance adc_test_i/processing_system7_0/inst
...
current_instance
current_instance adc_test_i/axi_dma_0/U0
...
current_instance
current_instance {adc_test_i/smartconnect_0/inst/s00_nodes/s00_aw_node/inst/inst_mi_handler/gen_normal_area.inst_fifo_node_payld/gen_xpm_memory_fifo.inst_fifo/gen_mem_rep[0].inst_xpm_memory}
...
current_instance
current_instance {adc_test_i/smartconnect_0/inst/s00_nodes/s00_b_node/inst/inst_mi_handler/gen_normal_area.inst_fifo_node_payld/gen_xpm_memory_fifo.inst_fifo/gen_mem_rep[0].inst_xpm_memory}
set_property src_info {type:SCOPED_XDC file:4 line:3 export:INPUT save:NONE read:READ} [current_design]
set my_var [get_property dram_emb_xdc [get_cells -hier  -filter {PRIMITIVE_SUBGROUP==LUTRAM || PRIMITIVE_SUBGROUP==dram || PRIMITIVE_SUBGROUP==uram || PRIMITIVE_SUBGROUP==BRAM}]]
current_instance
current_instance {adc_test_i/smartconnect_0/inst/s00_nodes/s00_w_node/inst/inst_mi_handler/gen_normal_area.inst_fifo_node_payld/gen_xpm_memory_fifo.inst_fifo/gen_mem_rep[0].inst_xpm_memory}

...
HD_PWD='C:/git/bldc-driver-fpga/hardware_design/vivado_project/tadc/tadc.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tadc_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tadc_wrapper.tcl -notrace

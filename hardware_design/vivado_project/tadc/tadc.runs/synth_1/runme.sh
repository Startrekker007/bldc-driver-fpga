...
HD_PWD='C:/git/bldc-driver-fpga/hardware_design/vivado_project/tadc/tadc.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tadc_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tadc_wrapper.tcl

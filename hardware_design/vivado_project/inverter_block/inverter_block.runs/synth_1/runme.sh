...
HD_PWD='C:/git/bldc-driver-fpga/hardware_design/vivado_project/inverter_block/inverter_block.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log INVERTER_BD_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source INVERTER_BD_wrapper.tcl

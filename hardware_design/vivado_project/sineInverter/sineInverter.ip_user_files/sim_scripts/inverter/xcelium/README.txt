...
#
# Generated by export_simulation on Sat Aug 06 20:47:43 +1200 2022
#
################################################################################
...
'-reset_run' switch to the './inverter.sh' script.

./inverter.sh -reset_run
...
./inverter.sh -noclean_files

For more information on the script, please type './inverter.sh -help'.

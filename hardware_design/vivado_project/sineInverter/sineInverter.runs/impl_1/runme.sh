...
HD_PWD='C:/git/bldc-driver-fpga/hardware_design/vivado_project/sineInverter/sineInverter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log inverter_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source inverter_wrapper.tcl -notrace

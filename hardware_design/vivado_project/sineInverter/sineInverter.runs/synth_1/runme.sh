...
HD_PWD='C:/git/bldc-driver-fpga/hardware_design/vivado_project/sineInverter/sineInverter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log inverter_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source inverter_wrapper.tcl

...
#
# Generated by export_simulation on Sun Jan 30 19:56:56 +1300 2022
#
################################################################################
...
'-reset_run' switch to the './inverse_clarke_0.sh' script.

./inverse_clarke_0.sh -reset_run
...
./inverse_clarke_0.sh -noclean_files

For more information on the script, please type './inverse_clarke_0.sh -help'.

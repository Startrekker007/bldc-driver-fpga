...
HD_PWD='C:/git/bldc-driver-fpga/hardware_design/vivado_project/clarke_hls_test/clarke_hls_test.runs/inverse_clarke_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log inverse_clarke_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source inverse_clarke_0.tcl

...
reg    dds_TDATA_blk_n;
reg   [1:0] tmp_user_V_reg_140;
reg    ap_block_state1;
wire   [15:0] sdat_fu_124_p2;
wire    ap_CS_fsm_state4;
wire  signed [31:0] grp_fu_133_p2;
wire   [15:0] dds_dat_fu_115_p4;
wire   [15:0] grp_fu_133_p1;
reg    grp_fu_133_ce;
reg   [3:0] ap_NS_fsm;
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state4) & (tmp_user_V_reg_140 == 2'd0))) begin
        u_ap_vld = 1'b1;
    end else begin
        u_ap_vld = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state4) & (tmp_user_V_reg_140 == 2'd1))) begin
        v_ap_vld = 1'b1;
    end else begin
        v_ap_vld = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state4) & (tmp_user_V_reg_140 == 2'd2))) begin
        w_ap_vld = 1'b1;
    end else begin
        w_ap_vld = 1'b0;
    end
...
assign dds_dat_fu_115_p4 = {{grp_fu_133_p2[31:16]}};

assign grp_fu_133_p1 = grp_fu_133_p10;

assign grp_fu_133_p10 = scale;

assign sdat_fu_124_p2 = (dds_dat_fu_115_p4 + 16'd32767);

assign u = sdat_fu_124_p2;

assign v = sdat_fu_124_p2;

assign w = sdat_fu_124_p2;
